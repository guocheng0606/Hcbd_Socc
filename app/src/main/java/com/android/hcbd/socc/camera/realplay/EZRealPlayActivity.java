package com.android.hcbd.socc.camera.realplay;
...
import com.android.hcbd.socc.camera.util.ActivityUtils;
...
public class EZRealPlayActivity extends Activity implements OnClickListener, SurfaceHolder.Callback,
    ...
    private static final int REQUEST_CODE_PERMISSION_AUDIO = 99;
    private static final int REQUEST_CODE_SETTING = 89;
    /**
     * 动画时间
     */
...
//        client = new GoogleApiClient.Builder(this).addApi(AppIndex.API).build();
    ...
    private void requestPermission() {
        ...
        AndPermission.with(this)
                .requestCode(REQUEST_CODE_PERMISSION_AUDIO)
                ...
                .rationale(new RationaleListener() {
                    ...
                    public void showRequestPermissionRationale(int requestCode, final Rationale rationale) {
                        ...
                        // 自定义对话框
                        new AlertDialog.Builder(EZRealPlayActivity.this)
                                .setTitle("权限申请")
                                .setMessage("APP需要获取录制音频权限，以正常使用相关功能")
    ...
    private PermissionListener permissionListener = new PermissionListener() {
        ...
        public void onFailed(int requestCode, @NonNull List<String> deniedPermissions) {
            ...
            if(requestCode == REQUEST_CODE_PERMISSION_AUDIO) {
                ...
                if (AndPermission.hasAlwaysDeniedPermission(EZRealPlayActivity.this, deniedPermissions)) {
                    // 第一种：用默认的提示语。
                    //AndPermission.defaultSettingDialog(LoginActivity.this, REQUEST_CODE_SETTING).show();
                    // 第二种：用自定义的提示语。
                    AndPermission.defaultSettingDialog(EZRealPlayActivity.this, REQUEST_CODE_SETTING)
                            .setTitle("权限申请")
                            .setMessage("在设置-应用-北斗安全监测-权限中开启录制音频权限，以正常使用相关功能")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case REQUEST_CODE_SETTING: {
                ...
                if(AndPermission.hasPermission(EZRealPlayActivity.this,Permission.MICROPHONE)) {
                    //执行拥有权限时的下一步。
                } else {
                    ...
                    AndPermission.defaultSettingDialog(EZRealPlayActivity.this, requestCode)
                            .setTitle("权限申请")
